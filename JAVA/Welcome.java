...
public class Welcome extends Frame implements ActionListener,WindowListener {
    ...
    Welcome() {
        ...
        setLayout(null);
        setVisible(true);
        setBackground(new Color(0xFDFdd));
        setResizable(false);
        addWindowListener(this);

        Label l = new Label("Welcome To  Abstract Windowing Toolkit  Project  ");
        l.setBounds(130, 358, 700, 25);
        l.setFont(new Font("Arial", Font.BOLD, 20));
        l.setForeground(new Color(0xED650678, true));
        add(l);
        Label sign = new Label("Shweta Tiwari");
        sign.setBounds(300, 383, 250, 23);
        sign.setFont(new Font("Segoe UI", Font.ITALIC, 15));
        ...
        clg.setFont(new Font("SanSarif", Font.BOLD, 23));
        clg.setForeground(new Color(0x579529));
        add(clg);
        ...
        b1.setForeground(new Color(0xED650678));
        add(b1);
        ...
        b2.setForeground(new Color(0xED650678));
        add(b2);
