...
public class Admin_Logged_IN extends Frame implements ActionListener, WindowListener, MouseListener {
   ...
   Admin_Logged_IN(String a) {
       ...
       l.setForeground(new Color(0xF61006));
       add(l);

       Label st = new Label("Students Information");
       st.setBounds(105, 135, 200, 30);
       st.setFont(new Font("", Font.BOLD, 20));
       st.setForeground(new Color(0x531279));
       add(st);

       b1 = new Button("Add");
       b1.setBounds(145, 200, 80, 25);
       b1.setFont(new Font("Book Antiqua", Font.BOLD, 15));
       b1.setForeground(new Color(0xF3A8023));
       add(b1);
       ...
       b2.setForeground(new Color(0xF3A8023));
       add(b2);
       ...
       ur.setFont(new Font("", Font.BOLD, 20));
       ur.setForeground(new Color(0x531279));
       add(ur);

       b3 = new Button("Add");
       b3.setBounds(375, 200, 80, 25);
       b3.setFont(new Font("Book Antiqua", Font.BOLD, 15));
       b3.setForeground(new Color(0xF3A8023));
       add(b3);
       ...
       b4.setForeground(new Color(0xF3A8023));
       add(b4);
       ...
       lgot.setForeground(new Color(0x531279));
       add(lgot);
